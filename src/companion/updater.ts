...
export const COMPANION_MANIFEST: CompanionManifest = {
  ...
  checksums: {
    'oh-my-opencode-serverlocal-companion-v0.1.3-aarch64-apple-darwin.tar.gz':
      'b4885f9b1900c02376e5f8f5ae6f3b8a89d26f7514b03f836d7e3d618164a0ed',
    'oh-my-opencode-serverlocal-companion-v0.1.3-aarch64-unknown-linux-gnu.tar.gz':
      'ed7cffc583e1eaa78c9bea702e6b6aa3bbc5bb4d881713fb2050237ba6b7aca5',
    'oh-my-opencode-serverlocal-companion-v0.1.3-x86_64-apple-darwin.tar.gz':
      '98d8ea7c7bc4415b18e0d4c524adb4eb9a84c872919840fdc021f0f50c61f808',
    'oh-my-opencode-serverlocal-companion-v0.1.3-x86_64-pc-windows-msvc.zip':
      '9316a49bf01f3b4fb1ce2d62edfc46094e73bb153d6ce023fb7df085afcf77bd',
    'oh-my-opencode-serverlocal-companion-v0.1.3-x86_64-unknown-linux-gnu.tar.gz':
