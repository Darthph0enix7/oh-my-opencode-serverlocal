...
Core plugin implementation for **oh-my-opencode-serverlocal**, providing:
...
1. **State Path Resolution**: Determines XDG-compliant state directory (`~/.local/share/opencode/storage/oh-my-opencode-serverlocal/tui-state.json`)
